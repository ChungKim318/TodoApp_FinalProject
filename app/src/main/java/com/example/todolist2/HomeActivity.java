...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String email_bundle = bundle.getString("email");
        String[] separated = email_bundle.split("@");
        separated[0] = separated[0].trim();
        txtHello.setText("hi,"+" "+separated[0]);
        //
        ...
        //khi bam vao bieu tuong
        btnCalender = (ImageView) findViewById(R.id.btnCalendar);
